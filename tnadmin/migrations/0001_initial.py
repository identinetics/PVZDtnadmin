    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gvOuId', models.CharField(db_column='gvouid', help_text='Syntax: gvOuId::= Landeskennung ":" ID; ID::= "VKZ:" VKZ | Org-Id  (z.B. AT:VKZ:GGA1234, AT:L9:9876)', max_length=32, unique=True, validators=[django.core.validators.RegexValidator(message='OuId erlaubt Kleinbuchstaben erst ab Position 11', regex='^[A-Z:]{10,10}.*')], verbose_name='gvOuId')),
                ...
                ('gvouid_upper', models.CharField(default='', max_length=250, unique=True)),
                ('gvouvkz_upper', models.CharField(default='', max_length=250, unique=True)),
